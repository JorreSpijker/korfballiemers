...
type MapRegionProps = {
  ...
  /** Fill color for the polygon (default: primary color with opacity) */
  fillColor?: string;
  /** Fill opacity from 0 to 1 (default: 0.2) */
  fillOpacity?: number;
  /** Stroke color for the polygon border (default: primary color) */
  strokeColor?: string;
  /** Stroke width in pixels (default: 2) */
  strokeWidth?: number;
  /** Stroke opacity from 0 to 1 (default: 0.8) */
  strokeOpacity?: number;
  /** Optional unique identifier for the region layer */
  id?: string;
};
...
function MapRegion({
  ...
  useEffect(() => {
    ...
    map.setPaintProperty(fillLayerId, "fill-color", defaultFillColor);
    map.setPaintProperty(fillLayerId, "fill-opacity", fillOpacity);
    map.setPaintProperty(strokeLayerId, "line-color", defaultStrokeColor);
